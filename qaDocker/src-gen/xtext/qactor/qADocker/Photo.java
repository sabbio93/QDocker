 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.qactor.qADocker.Photo#getDestfile <em>Destfile</em>}</li>
 *   <li>{@link xtext.qactor.qADocker.Photo#getAnswerEvent <em>Answer Event</em>}</li>
 * </ul>
 *
 * @see xtext.qactor.qADocker.QADockerPackage#getPhoto()
 * @model
 * @generated
 */
public interface Photo extends ExtensionMove
{
   ...
   * @see xtext.qactor.qADocker.QADockerPackage#getPhoto_Destfile()
  ...
  /**
   * Sets the value of the '{@link xtext.qactor.qADocker.Photo#getDestfile <em>Destfile</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see xtext.qactor.qADocker.QADockerPackage#getPhoto_AnswerEvent()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link xtext.qactor.qADocker.Photo#getAnswerEvent <em>Answer Event</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
