 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.qactor.qADocker.MemoCurrentEvent#isLastonly <em>Lastonly</em>}</li>
 * </ul>
 *
 * @see xtext.qactor.qADocker.QADockerPackage#getMemoCurrentEvent()
 * @model
 * @generated
 */
public interface MemoCurrentEvent extends BasicMove
{
   ...
   * @see xtext.qactor.qADocker.QADockerPackage#getMemoCurrentEvent_Lastonly()
   * @model
   * @generated
   */
  boolean isLastonly();
  ...
  /**
   * Sets the value of the '{@link xtext.qactor.qADocker.MemoCurrentEvent#isLastonly <em>Lastonly</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
